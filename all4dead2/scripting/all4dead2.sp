...
public Plugin:myinfo = {
	name = PLUGIN_NAME,
	author = "James Richardson (grandwazir) & Harry",
...
public OnPluginStart() {
	...
	//automatic_placement = CreateConVar("a4d_automatic_placement", "1", "Whether or not we ask the director to place things we spawn.",FCVAR_PROTECTED);
...
public Action:Menu_CreateWeaponMenu(client, args) {
	...
	AddMenuItem(menu, "s1", "Spawn a pistol");
	AddMenuItem(menu, "s2", "Spawn a magnum");
	AddMenuItem(menu, "s3", "Spawn a pumpshotgun");
	AddMenuItem(menu, "s4", "Spawn a shotgun chrome");
	AddMenuItem(menu, "s5", "Spawn a sub machine gun");
	AddMenuItem(menu, "s6", "Spawn a silenced smg");
	AddMenuItem(menu, "s7", "Spawn a mp5");
	AddMenuItem(menu, "s8", "Spawn an assault rifle");
	AddMenuItem(menu, "s9", "Spawn a sg552 rifle");
	AddMenuItem(menu, "s0", "Spawn an AK74");
	AddMenuItem(menu, "sa", "Spawn a desert rifle");
	AddMenuItem(menu, "sb", "Spawn a shotgun spas");
	AddMenuItem(menu, "sc", "Spawn an auto shotgun");
	AddMenuItem(menu, "sd", "Spawn a hunting rifle");
	AddMenuItem(menu, "se", "Spawn a military sniper");
	AddMenuItem(menu, "sf", "Spawn a scout");
	AddMenuItem(menu, "sg", "Spawn an awp");
	AddMenuItem(menu, "sh", "Spawn a grenade launcher");
	AddMenuItem(menu, "si", "Spawn a m60");
	DisplayMenu(menu, client, MENU_DISPLAY_TIME);
	return Plugin_Handled;
}
